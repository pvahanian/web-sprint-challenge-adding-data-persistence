...
Relational Database is the the structure and design and SQL is the a language/software to query and access that data
2. Why do tables need a `primary key`?
So we can keep track of every entry and allow accessability 
3. What is the name given to a table column that references the primary key on another table.
Foreign key
4. What do we need in order to have a _many to many_ relationship between two tables.
Multiple columns having connections.  So an example would be authors to books.  Authors can have multiple books and vs versa
